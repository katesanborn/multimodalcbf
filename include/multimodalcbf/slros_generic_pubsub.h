...
class SimulinkPublisher {
  ...
  public:
    ...
    void publish(const BusType* busPtr);
 ...
 */
template <class MsgType, class BusType>
void SimulinkPublisher<MsgType, BusType>::publish(const BusType* busPtr) {
 ...
 */
template <class MsgType, class BusType>
void SimulinkRTPublisher<MsgType, BusType>::publish(const BusType* busPtr) {
